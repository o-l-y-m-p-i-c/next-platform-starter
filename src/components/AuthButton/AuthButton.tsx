          ...
          async function loginWallet({
            ...
            try {
              ...
              if (namespace === 'unknown')
                throw new Error('Wrong network. Use Ethereum or BNB Chain');
              ...
              const typedError = error as Error;
              toast.error(
                typedError?.message || 'Error when connecting the wallet',
              );
              console.error(error);
              resetAll();
              setUser();
                  ...
                  if (!connected) {
                    return (
                      <Button
                        ...
                        type="button"
                      >
                        {isDesktop || isOnlyDesktopVersion ? (
                          btnLabel
                        ) : (
                          <LoginIcon />
                        )}
            ...
            <DialogContent dividers>
              ...
              >
                <Typography variant="h5">
                  Your account was successfully created, and your waitlist
                  position is #{user?.user?.whiteListNumber}
                </Typography>
          ...
          <>
            ...
            <DialogContent dividers>
              ...
              >
                ...
                <Typography>
                  Get private access to our Telegram AI-Bot!
                </Typography>
                <Stack
                  width={'100%'}
                  gap={1}
